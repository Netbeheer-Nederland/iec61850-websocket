...
from ws61850.iec61850.data_model.ied_model import DataObject, DataAttribute, DataAttributeType, FunctionalConstraint
...
def create_mv_do(name:str, parent):
    ...
    da_quality = DataAttribute('q', 0, -1, DataAttributeType.quality, FunctionalConstraint.mx, 0, default_quality, 0,
                               do)
    da_time_stamp = DataAttribute('t', 0, -1, DataAttributeType.timeStamp, FunctionalConstraint.mx, 0, default_timestamp, 0,
                                  do)
...
def create_apc_do(name:str, parent):
    ...
    # oper
    da_oper = DataAttribute("Oper", 0, -1, DataAttributeType.structure, FunctionalConstraint.co, 0, [], 0,
                            do)
    ...
    da_orIdent = DataAttribute('orIdent', 0, -1, DataAttributeType.octetString, FunctionalConstraint.co, 0, bytes(), 0, da_origin)
    ...
    da_T = DataAttribute("T", 0, -1, DataAttributeType.timeStamp, FunctionalConstraint.co, 0, default_timestamp, 0, da_oper)
    da_Test = DataAttribute("Test", 0, -1, DataAttributeType.boolean, FunctionalConstraint.co, 0, False, 0, da_oper)
    da_Check = DataAttribute("Check", 0, -1, DataAttributeType.check, FunctionalConstraint.co, 0, {'synchroCheck': False, 'interlockCheck': False}, 0, da_oper)

    da_syncroCheck = DataAttribute("synchroCheck", 0, -1, DataAttributeType.boolean, FunctionalConstraint.co, 0, False, 0, da_Check)
    da_interlockCheck = DataAttribute("interlockCheck", 0, -1, DataAttributeType.boolean, FunctionalConstraint.co, 0, False, 0, da_Check)
    ...
    # mxVal
    da_mxVal = DataAttribute("mxVal", 0, -1, DataAttributeType.structure, FunctionalConstraint.mx, 0, [], 0,
                             do)
    ...
    #units:
    da_units = DataAttribute('units', 0, -1, DataAttributeType.structure, FunctionalConstraint.cf, 0, [], 0, do)
    da_siUnit = DataAttribute('SIUnit', 0, -1, DataAttributeType.enumerated, FunctionalConstraint.cf, 0, 0, 0,
                              da_units)
    da_multiplier = DataAttribute('multiplier', 0, -1, DataAttributeType.enumerated, FunctionalConstraint.cf, 0, 0, 0,
                                  da_units)
...
def create_inc_do(name:str, parent):
    ...
    da_quality = DataAttribute('q', 0, -1, DataAttributeType.quality, FunctionalConstraint.st, 0, default_quality, 0,
                               do)
    da_time_stamp = DataAttribute('t', 0, -1, DataAttributeType.timeStamp, FunctionalConstraint.st, 0, default_timestamp, 0,
                                  do)
    da_ctlModel = DataAttribute('ctlModel', 0, -1, DataAttributeType.enumerated, FunctionalConstraint.cf, 0, 1, 0, do)
    da_dataNs = DataAttribute('dataNs', 0, -1, DataAttributeType.visString255, FunctionalConstraint.ex, 0, "", 0, do)
...
def create_ens_do(name : str, parent):
    ...
    da_quality = DataAttribute('q', 0, -1, DataAttributeType.quality, FunctionalConstraint.st, 0, default_quality, 0,
                               do)
    da_time_stamp = DataAttribute('t', 0, -1, DataAttributeType.timeStamp, FunctionalConstraint.st, 0,
                                  default_timestamp, 0,
                                  do)
...
def create_lpl_do(name : str, parent):
    ...
    da_configRev = DataAttribute('configRev', 0, -1, DataAttributeType.visString255, FunctionalConstraint.dc, 0, "", 0, do)
...
def create_dpl_do(name : str, parent):
    ...
    da_location = DataAttribute('location', 0, -1, DataAttributeType.visString255, FunctionalConstraint.dc, 0, "", 0, do)
...
def create_cmv_do(name : str, parent):
    ...
    da_f = DataAttribute('f', 0, -1, DataAttributeType.float32, FunctionalConstraint.mx, 0, 0.0, 0, da_mag)
    da_quality = DataAttribute('q', 0, -1, DataAttributeType.quality, FunctionalConstraint.mx, 0, default_quality, 0, do)
    da_time_stamp = DataAttribute('t', 0, -1, DataAttributeType.timeStamp, FunctionalConstraint.mx, 0, default_timestamp, 0, do)
