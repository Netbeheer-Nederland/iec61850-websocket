...
image::RTI_Demo_System_Architecture_Overview.png[RTI Demo System Architecture Overview,link="RTI_Demo_System_Architecture_Overview.png"]
...
|RTI-FSP/RTI-SO |demo_IO |HTTP/REST |8000
...
- `examples/rti-demo/modules/fsp/README.md` - (FSP implementation)
- `examples/rti-demo/modules/so/README.md` - (SO implementation)
- `examples/rti-demo/modules/bff/README.md` - (BFF implementation)
- `examples/rti-demo/modules/hmi/README.md` - (HMI implementation)
- `examples/rti-demo/modules/demo_io/README.md` - (IO control)
