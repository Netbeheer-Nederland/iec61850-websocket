...
image::BFF.png[BFF Architecture,link="BFF.png"]
...
|   +-- connections.json       # Seed/default connection configurations
+-- tests/
+-- README.md
----
...
image::Sequence_Diagram-Dynamic_Execution_via_POST__api_execute.png[Dynamic Execution Sequence Diagram,link="Sequence_Diagram-Dynamic_Execution_via_POST__api_execute.png"]
...
image::Security_and_OAuth_2.0_Communication_Flow.png[Security and OAuth 2.0 Communication Flow,link="Security_and_OAuth_2.0_Communication_Flow.png"]
...
Without Docker (from repository root - `bff` is a member of the shared
uv workspace):
----
