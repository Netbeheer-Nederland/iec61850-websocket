...
. **Dockerfiles** exist:
   - `examples/rti-demo/modules/bff/docker/Dockerfile`
   - `examples/rti-demo/modules/hmi/docker/Dockerfile`
   - `examples/rti-demo/modules/io/docker/Dockerfile`
   - `examples/rti-demo/modules/fsp/docker/Dockerfile`
   - `examples/rti-demo/modules/so/docker/Dockerfile`
...
|Build fails - missing Dockerfile |`ls -la examples/rti-demo/modules/bff/docker/Dockerfile`
