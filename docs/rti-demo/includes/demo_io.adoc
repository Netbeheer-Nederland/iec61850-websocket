...
|Potentiometer |Analog input via MCP3008 ADC (SPI) |INPUT |SPI bus, device, channel, min/max values
...
* MCP3008 ADC: For analog inputs (potentiometers) via SPI
* Potentiometer: 10kΩ recommended (4 channels supported)
...
|pot1 |Potentiometer |MCP3008 Ch 0 |- |INPUT |SPI ADC Channel 0
|pot2 |Potentiometer |MCP3008 Ch 1 |- |INPUT |SPI ADC Channel 1
|pot3 |Potentiometer |MCP3008 Ch 2 |- |INPUT |SPI ADC Channel 2
|pot4 |Potentiometer |MCP3008 Ch 3 |- |INPUT |SPI ADC Channel 3
|lcd1 |LCD 16x2 |Multiple |Multiple |OUTPUT |HD44780 4-bit mode
|lcd_i2c |LCD I2C |I2C 0x27/0x39 |- |OUTPUT |HD44780 with PCF8574 I2C backpack
|===
...
**MCP3008 ADC (SPI) for Potentiometers**:
* MOSI: GPIO 10 (Pin 19) -> MCP3008 Pin 11 (DIN)
* MISO: GPIO 9 (Pin 21) -> MCP3008 Pin 12 (DOUT)
* CLK: GPIO 11 (Pin 23) -> MCP3008 Pin 13 (CLK)
* CS/SS: GPIO 8 (Pin 24, CE0) -> MCP3008 Pin 10 (CS/SHDN)
* VDD: +3.3V -> MCP3008 Pin 16
* VREF: +3.3V -> MCP3008 Pin 15
* AGND: GND -> MCP3008 Pin 14
* Potentiometer 1: Analog input -> MCP3008 Pin 1 (CH0)
* Potentiometer 2: Analog input -> MCP3008 Pin 2 (CH1)
* Potentiometer 3: Analog input -> MCP3008 Pin 3 (CH2)
* Potentiometer 4: Analog input -> MCP3008 Pin 4 (CH3)

**LCD 16x2 (HD44780 - Parallel 4-bit mode)**:
...
**LCD I2C (HD44780 with PCF8574 backpack)**:
* I2C Address: 0x27 (default) or 0x39
* I2C Bus: 1 (SDA: GPIO 2, SCL: GPIO 3)
* SDA: GPIO 2 (Pin 3) -> PCF8574 SDA
* SCL: GPIO 3 (Pin 5) -> PCF8574 SCL
* VDD: +5V -> PCF8574 VCC
* GND: GND -> PCF8574 GND
* Backlight control via I2C bits (configurable in io_config.json)
...
----
{
  "devices": [
    ...
    },
    {
      ...
      "type": "button",
      "gpio_pin": 4,
      "description": "Button on GPIO 4 (Pin 7)",
      "direction": "input",
      "debounce_time": 0.05,
      "pull_up": true,
      "latching": true,
    ...
    },
    {
      ...
      "min_value": 0.0,
      "max_value": 100.0,
      "description": "Potentiometer on MCP3008 channel 0"
    },
    {
      "name": "lcd1",
      "device_type": "lcd",
      ...
      "gpio_rs": 26,
      "gpio_e": 19,
      "gpio_data": [13, 12, 16, 20],
      "columns": 16,
      "rows": 2,
      "description": "16x2 LCD Display with HD44780 controller (4-bit mode)",
      "direction": "output"
    },
    {
      "name": "lcd_i2c",
      ...
      "columns": 16,
      "rows": 2,
      "description": "16x2 LCD with I2C backpack (PCF8574)",
      "direction": "output"
    }
  ]
}
