...
from bff.connection.profile import ApplicationRole, ConnectionProfile
...
TARGET_ALIASES = {
    "rti-so": "rti-so",
    "rtiSo": "rti-so",
    "server-client": "rti-so",      # backwards-compat alias
    "serverClient": "rti-so",
    "rti-fsp": "rti-fsp",
    "rtiFsp": "rti-fsp",
    "client-server": "rti-fsp",     # backwards-compat alias
    "clientServer": "rti-fsp",
}
