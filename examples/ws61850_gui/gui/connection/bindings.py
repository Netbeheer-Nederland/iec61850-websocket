...
class IecClientBinding:
    ...
    def attach(self, endpoint: EndpointProtocol) -> None:
    ...
    def status(
        self,
        endpoint: EndpointProtocol | None,
    ...
    def ensure_connection(
        ...
        loop: asyncio.AbstractEventLoop | None,
        timeout: int,
    ) -> tuple[IEC61850Client, EndpointProtocol, WebSocketInfo, asyncio.AbstractEventLoop]:
